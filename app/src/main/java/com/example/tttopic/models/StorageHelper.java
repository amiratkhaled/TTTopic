...
import com.example.tttopic.Auth;
...
public class StorageHelper {
    ...
    public File getStorageFile() {
        ...
        File digestFile = new File(filesDir, Auth.Constants.STORAGE_FILE);
        return digestFile;
    }
    ...
    public boolean writeContentToStorage(JSONObject json) throws IOException, JSONException {
        ...
        outputStream = mContext.openFileOutput(Auth.Constants.STORAGE_FILE, Context.MODE_PRIVATE);
